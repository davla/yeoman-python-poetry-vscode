...
export default class InputGenerator extends Generator {
  ...
  async initializing() {
    ...
    await Promise.all(this.inputs.map((input) => input.initValue()));
  }
